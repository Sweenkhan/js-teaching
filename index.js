...
input.addEventListener("keyup", (event)=>{  
      ...
      let modifyValue = event.key.toUpperCase() 

  input.value = input.value.replace(event.key, modifyValue)
...
btnReverse.addEventListener("click", ()=>{
   ...
   // let backtoArray = reverse.join("") 
   // document.querySelector(".show").innerHTML = backtoArray.slice(2)
   ...
   document.querySelector(".show").innerHTML = data.split("").reverse().join("").slice(2)
